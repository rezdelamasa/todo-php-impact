...
Create a to-do list application using PHP and any framework.
...
-   Create a simple "analytics" page that shows the number of the to-dos created and the number of the to-dos completed in a specific time frame (default last 7 days). Using query parameters, the page should accept a date range (start date - end date) and filter the to-dos accordingly.
